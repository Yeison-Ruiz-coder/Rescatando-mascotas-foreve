<nav class="navbar navbar-expand-xl custom-navbar" data-bs-theme="dark">
    <div class="container-fluid">
        ...
        <a class="navbar-brand" href="{{ route('inicio') }}">
            <img src="{{ asset('img/logo-blanco.png') }}" alt="Rescatando Mascotas Forever" class="navbar-logo">
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarMainContent">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link main-link" href="{{ route('inicio') }}">Inicio</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link main-link" href="{{ route('reportes.create') }}">Reporta</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link main-link" href="{{ route('public.mascotas.index') }}">Adopta</a>
                </li>
                <li class="nav-item">
            ...
            <div class="navbar-actions ms-3">
                <button class="btn btn-outline-light btn-sm me-2" onclick="window.location.href='{{ route('login') }}'">
                    <i class="fas fa-sign-in-alt me-1"></i>Login
                </button>
                <button class="btn btn-primary btn-sm" onclick="window.location.href='{{ route('register') }}'">
