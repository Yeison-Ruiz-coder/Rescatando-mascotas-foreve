@extends('portals.admin.layouts.admin')
@push('styles')
        ...
        <div class="col-12">
            ...
            <div class="adopciones-header">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('admin.adopciones.create') }}" class="btn btn-primary">
            ...
            <div class="card filtros-card">
                ...
                <div class="card-body filtros-body">
                    <form action="{{ route('admin.adopcione.index') }}" method="GET">
                        <div class="row g-3">
                            <!-- Búsqueda por lugar -->
                            <div class="col-md-3">
                            ...
                            <div class="col-md-12">
                                <div class="d-flex gap-2 mt-3">
                                    ...
                                    <a href="{{ route('admin.adopcione.index') }}" class="btn btn-outline-primary">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="alert alert-info py-2 mb-0">
                        <small>
                            ...
                            Filtros aplicados. 
                            <a href="{{ route('admin.adopcione.index') }}" class="alert-link">Ver todas</a>
                        </small>
                    </div>
                    @endif
                </div>
                ...
                <div class="card-body p-0">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group btn-group-sm btn-group-acciones">
                                                <a href="{{ route('admin.adopcione.show', $adopcion->id) }}" 
                                                   class="btn btn-outline-info" title="Ver detalles">
                                                    <i class="fas fa-eye"></i>
                                                </a>
                                                <a href="{{ route('admin.adopcione.edit', $adopcion->id) }}" 
                                                   class="btn btn-outline-primary" title="Editar">
                                                    <i class="fas fa-edit"></i>
                                                </a>
                                                <form action="{{ route('admin.adopcione.destroy', $adopcion->id) }}" 
                    ...
                    @else
                        ...
                        <div class="estado-vacio">
                            ...
                            <a href="{{ route('admin.adopcione.create') }}" class="btn btn-primary btn-lg">
