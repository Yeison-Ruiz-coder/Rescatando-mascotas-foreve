            ...
            <div class="col-md-10">
                <div class="card shadow">
                    <div class="card-body">
                        ...
                        <h1 class="card-title text-turquesa">{{ $evento->Nombre_evento }}</h1>
                        
                        <div class="row mb-4 bg-light rounded p-3">
                            <div class="col-md-6">
                                <div class="d-flex align-items-center mb-2">
                                    <strong class="me-2"><i class="fas fa-map-marker-alt text-turquesa"></i> Lugar:</strong>
                                    <span>{{ $evento->Lugar_evento }}</span>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="d-flex align-items-center mb-2">
                                    <strong class="me-2"><i class="fas fa-calendar-alt text-turquesa"></i> Fecha:</strong>
                        ...
                        <div class="mb-4">
                            <h5 class="text-turquesa">Descripción del Evento:</h5>
