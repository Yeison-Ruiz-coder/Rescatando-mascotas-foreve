        ...
        <div class="row">
            ...
            <div class="col-lg-2 col-md-6 mb-4">
                ...
                <ul class="list-unstyled">
                    <li><a href="<?php echo e(url('/')); ?>" class="text-light text-decoration-none">Inicio</a></li>
                    <li><a href="<?php echo e(route('public.mascotas.index')); ?>" class="text-light text-decoration-none">Adoptar</a></li>
                    <li><a href="<?php echo e(route('rescates.create')); ?>" class="text-light text-decoration-none">Rescatar</a></li>
                    <li><a href="<?php echo e(route('donaciones.create')); ?>" class="text-light text-decoration-none">Donar</a></li>
                </ul>
            </div>
...
</footer><?php /**PATH C:\Users\Personal\Desktop\rescatando-mascotas\resources\views/home/partials/footer.blade.php ENDPATH**/ ?>