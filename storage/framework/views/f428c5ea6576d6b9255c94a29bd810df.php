...
<aside class="public-sidebar" id="publicSidebar">
    ...
    <nav class="public-sidebar-nav">
        ...
        <div class="public-sidebar-section">
            ...
            <a href="<?php echo e(url('/rescates')); ?>"
                class="public-sidebar-item public-rescate-item <?php echo e(request()->is('rescates*') ? 'active' : ''); ?>">
            ...
            <a href="<?php echo e(url('/rescates/activos')); ?>"
                class="public-sidebar-subitem <?php echo e(request()->is('rescates/activos') ? 'active' : ''); ?>">
                <i class="fas fa-map-marker-alt"></i>
                <span>Rescates activos</span>
            </a>

            
            <a href="<?php echo e(url('/rescates/historial')); ?>"
                class="public-sidebar-subitem <?php echo e(request()->is('rescates/historial') ? 'active' : ''); ?>">
            ...
            <a href="<?php echo e(url('/reportes')); ?>"
                class="public-sidebar-item <?php echo e(request()->is('reportes*') ? 'active' : ''); ?>">
        ...
        <div class="public-sidebar-section">
            ...
            <a href="<?php echo e(url('/mascotas')); ?>"
                class="public-sidebar-item <?php echo e(request()->is('mascotas*') ? 'active' : ''); ?>">
            ...
            <div class="public-sidebar-submenu <?php echo e(request()->routeIs('public.adopciones.*') ? 'open' : ''); ?>">
                <a href="<?php echo e(route('public.adopciones.index')); ?>"
                    class="public-sidebar-subitem <?php echo e(request()->routeIs('public.adopciones.index') ? 'active' : ''); ?>">
                ...
                <?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(route('public.adopciones.mis-solicitudes')); ?>"
                        class="public-sidebar-subitem <?php echo e(request()->routeIs('public.adopciones.mis-solicitudes') ? 'active' : ''); ?>">
                        <i class="fas fa-clipboard-list"></i>
                        <span>Mis solicitudes</span>
                    </a>

                    <a href="<?php echo e(route('public.adopciones.en-proceso')); ?>"
                        class="public-sidebar-subitem <?php echo e(request()->routeIs('public.adopciones.en-proceso') ? 'active' : ''); ?>">
        ...
        <div class="public-sidebar-section">
            ...
            <a href="<?php echo e(url('/suscripciones')); ?>"
                class="public-sidebar-item <?php echo e(request()->is('suscripciones*') ? 'active' : ''); ?>">
        ...
        <div class="public-sidebar-section">
            ...
            <a href="<?php echo e(url('/tiendas')); ?>"
                class="public-sidebar-item <?php echo e(request()->is('tiendas*') ? 'active' : ''); ?>">
            ...
            <div class="public-sidebar-submenu <?php echo e(request()->is('veterinarias*') ? 'open' : ''); ?>">
                <a href="<?php echo e(url('/veterinarias')); ?>"
                    class="public-sidebar-subitem <?php echo e(request()->is('veterinarias') ? 'active' : ''); ?>">
                    <i class="fas fa-list"></i>
                    <span>Todas</span>
                </a>
                <a href="<?php echo e(url('/veterinarias/urgencias')); ?>"
                    class="public-sidebar-subitem <?php echo e(request()->is('veterinarias/urgencias') ? 'active' : ''); ?>">
                    <i class="fas fa-ambulance"></i>
                    <span>Urgencias 24/7</span>
                    <span class="badge bg-danger">24h</span>
                </a>
                <a href="<?php echo e(url('/veterinarias/mapa')); ?>"
                    class="public-sidebar-subitem <?php echo e(request()->is('veterinarias/mapa') ? 'active' : ''); ?>">
        ...
        <div class="public-sidebar-section">
            ...
            <a href="<?php echo e(url('/usuarios')); ?>"
                class="public-sidebar-item <?php echo e(request()->is('usuarios*') ? 'active' : ''); ?>">
                <i class="fas fa-users"></i>
                <span>Usuarios</span>
            </a>

            
            <a href="<?php echo e(url('/comentarios')); ?>"
                class="public-sidebar-item <?php echo e(request()->is('comentarios*') ? 'active' : ''); ?>">
        ...
        <div class="public-sidebar-section">
            ...
            <a href="<?php echo e(url('/nosotros')); ?>"
                class="public-sidebar-item <?php echo e(request()->is('nosotros') ? 'active' : ''); ?>">
