                ...
                <div class="col-md-6">
                    <div class="form-check form-switch mb-2">
                        <input class="form-check-input"
                               ...
                               value="1"
                               <?php echo e(old('necesita_hogar_temporal') ? 'checked' : ''); ?>>
                ...
                <div class="col-md-6">
                    <div class="form-check form-switch mb-2">
                        <input class="form-check-input"
                               ...
                               name="apto_con_ninos"
                               value="1"
                               <?php echo e(old('apto_con_ninos', true) ? 'checked' : ''); ?>>
                ...
                <div class="col-md-6">
                    <div class="form-check form-switch mb-2">
                        <input class="form-check-input"
                               ...
                               value="1"
                               <?php echo e(old('apto_con_otros_animales', true) ? 'checked' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>"
                    ...
                    <?php $__currentLoopData = $vacunas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vacuna): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($vacuna->id); ?>"
                            <?php echo e(in_array($vacuna->id, old('vacunas', [])) ? 'selected' : ''); ?>>
...
<?php /**PATH C:\xampp\htdocs\Rescatando-mascotas-foreve\resources\views/admin/mascotas/partials/create/form-health.blade.php ENDPATH**/ ?>