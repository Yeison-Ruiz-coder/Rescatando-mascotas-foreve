...
<div class="create-form-container">
    <form action="<?php echo e(route('solicitud.store')); ?>" method="POST" class="solicitud-form">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-actions">
            ...
            <a href="<?php echo e(route('solicitud.index')); ?>" class="btn-cancel">
                <i class="fa-solid fa-times"></i> Cancelar
            </a>
        </div>
    </form>
</div><?php /**PATH C:\Users\Personal\Desktop\rescatando-mascotas\resources\views/admin/solicitud/partials/create/form.blade.php ENDPATH**/ ?>