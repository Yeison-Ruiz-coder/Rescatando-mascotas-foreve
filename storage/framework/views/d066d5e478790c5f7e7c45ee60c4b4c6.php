...
<link rel="stylesheet" href="<?php echo e(asset('css/pages/adopciones/show.css')); ?>">
<?php $__env->stopPush(); ?>
                ...
                <div class="card-header card-header-detalle d-flex justify-content-between align-items-center">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <small class="opacity-75">ID: #<?php echo e($adopcion->id); ?></small>
                        </div>
                    </div>
                    <div class="btn-group">
                        <a href="<?php echo e(route('adopciones.edit', $adopcion->id)); ?>" class="btn btn-light btn-sm">
                            <i class="fas fa-edit me-2"></i>Editar
                        </a>
                        <a href="<?php echo e(route('adopciones.index')); ?>" class="btn btn-light btn-sm">
                ...
                <div class="card-body p-4">
                            ...
                            <div class="seccion-info h-100">
                                ...
                                <?php if($adopcion->mascota): ?>
                                    <div class="info-item">
                                        ...
                                        <span class="valor"><?php echo e($adopcion->mascota->Nombre_mascota); ?></span>
                                    </div>
                                    <div class="info-item">
                                        <strong>Especie:</strong>
                                        <span class="valor"><?php echo e($adopcion->mascota->Especie); ?></span>
                                    </div>
                                    <div class="info-item">
                                        <strong>Raza:</strong>
                                        <span class="valor"><?php echo e($adopcion->mascota->Raza); ?></span>
                                    </div>
                                    <div class="info-item">
                                        <strong>Edad:</strong>
                                        <span class="valor"><?php echo e($adopcion->mascota->Edad_aprox); ?> años</span>
                                    </div>
                                    <div class="info-item">
                                        <strong>Género:</strong>
                                        <span class="valor"><?php echo e($adopcion->mascota->Genero); ?></span>
                                    </div>
                                    <div class="info-item">
                                        <strong>Estado:</strong>
                                        <span class="valor">
                                            <span class="badge badge-estado-detalle 
                                                <?php if($adopcion->mascota->estado == 'Adoptado'): ?> bg-success
                                                <?php elseif($adopcion->mascota->estado == 'En adopcion'): ?> bg-warning
                                                <?php else: ?> bg-info
                                                <?php endif; ?>">
                                                <?php echo e($adopcion->mascota->estado); ?>
                            ...
                            <div class="seccion-info h-100">
                                ...
                                <?php if($adopcion->usuario): ?>
                                    <div class="info-item">
                                        ...
                                        <span class="valor"><?php echo e($adopcion->usuario->Nombre_1); ?> <?php echo e($adopcion->usuario->Apellido_1); ?></span>
                                    </div>
                                    <?php if($adopcion->usuario->Nombre_2 || $adopcion->usuario->Apellido_2): ?>
                                    <div class="info-item">
                                        <strong>Nombres adicionales:</strong>
                                        <span class="valor"><?php echo e($adopcion->usuario->Nombre_2); ?> <?php echo e($adopcion->usuario->Apellido_2); ?></span>
                                    </div>
                                    <?php endif; ?>
                                    <div class="info-item">
                                        <strong>Email:</strong>
                                        <span class="valor"><?php echo e($adopcion->usuario->Email); ?></span>
                                    </div>
                                    <div class="info-item">
                                        <strong>Teléfono:</strong>
                                        <span class="valor"><?php echo e($adopcion->usuario->Telefono); ?></span>
                                    </div>
                                    <div class="info-item">
                                        <strong>Dirección:</strong>
                                        <span class="valor"><?php echo e($adopcion->usuario->Direccion); ?></span>
                                    </div>
                                    <div class="info-item">
                                        <strong>Tipo de usuario:</strong>
                                        <span class="valor">
                                            <span class="badge badge-estado-detalle bg-secondary">
                                                <?php echo e($adopcion->usuario->tipo); ?>
                    ...
                    <div class="botones-accion">
                        <div class="d-flex justify-content-between align-items-center">
                            <a href="<?php echo e(route('adopciones.index')); ?>" class="btn btn-volver">
                                <i class="fas fa-arrow-left me-2"></i>Volver al Listado
                            </a>
                            <div class="btn-group-acciones-detalle">
                                <a href="<?php echo e(route('adopciones.edit', $adopcion->id)); ?>" class="btn btn-editar-detalle">
                                    <i class="fas fa-edit me-2"></i>Editar Adopción
                                </a>
                                <form action="<?php echo e(route('adopciones.destroy', $adopcion->id)); ?>" method="POST" class="d-inline">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Dan\Desktop\Rescatando-mascotas-foreve\resources\views/adopciones/show.blade.php ENDPATH**/ ?>