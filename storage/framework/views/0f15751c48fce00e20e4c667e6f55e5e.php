<!-- Proceso de Adopción -->
<section id="proceso" class="proceso-section section-padding">
    <div class="container">
        ...
        <div class="text-center mt-4">
            <a href="<?php echo e(route('public.mascotas.index')); ?>" class="btn-primary-custom">
                <i class="fas fa-paw me-2"></i>Iniciar Proceso de Adopción
            </a>
        </div>
    </div>
</section><?php /**PATH C:\Users\Juanda\Desktop\Rescatando-mascotas-foreve\resources\views/home/partials/proceso.blade.php ENDPATH**/ ?>