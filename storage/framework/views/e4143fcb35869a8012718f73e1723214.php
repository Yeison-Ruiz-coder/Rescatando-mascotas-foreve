...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Gestión de Solicitudes'); ?> - Rescatando Mascotas</title>
    ...
    <header>
        <div class="top-bar">
            <div class="logo-container">
                <img src="<?php echo e(asset('img/logo.png')); ?>" alt="Rescatando Mascotas Logo" class="logo">
            </div>
            ...
            <nav class="main-nav">
                <ul class="nav-links">
                    ...
                    <li><a href="<?php echo e(route('solicitud.index')); ?>">SOLICITUDES</a></li>
...
</html><?php /**PATH C:\Users\Personal\Desktop\rescatando-mascotas\resources\views/solicitudes/index.blade.php ENDPATH**/ ?>