    ...
    <nav aria-label="breadcrumb" class="mb-4">
        <ol class="breadcrumb breadcrumb-mascota">
            <li class="breadcrumb-item">
                <a href="<?php echo e(route('mascotas.public.index')); ?>" class="text-decoration-none">
            ...
            <div class="card card-mascota">
                <div class="card-body text-center py-4">
                    <h5 class="card-title text-fucsia mb-3">
                        <i class="fas fa-heart me-2"></i>¿Te enamoraste de <?php echo e($mascota->Nombre_mascota); ?>?
                    </h5>
            ...
            <div class="card card-mascota">
                ...
                <div class="card-body p-4">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="info-circle">
                            <p class="text-muted mb-0" style="line-height: 1.6;">
                                <?php echo e($mascota->Descripcion); ?>
                    ...
                    <div class="d-grid gap-3 mt-4">
                        ...
                        <a href="<?php echo e(route('mascotas.public.index')); ?>" 
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Personal\Desktop\rescatando-mascotas\resources\views/mascotas/public-show.blade.php ENDPATH**/ ?>