        ...
        <ul class="nav second-row-nav">
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu second-row-menu" aria-labelledby="dropdownMascotas">
                    ...
                    <li><a class="dropdown-item" href="<?php echo e(route('public.mascotas.index')); ?>">Buscar</a></li>
                </ul>
            </li>
...
</div><?php /**PATH C:\Users\Juanda\Desktop\Rescatando-mascotas-foreve\resources\views/portals/public/partials/navbar/secondary-menu.blade.php ENDPATH**/ ?>