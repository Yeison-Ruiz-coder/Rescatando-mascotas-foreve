<div class="alert-card success mb-4">
    ...
    <div class="alert-body">
        ...
        <div class="alert-actions">
            <a href="<?php echo e(route('mascotas.index')); ?>" class="btn btn-outline-primary me-2">
...
</script><?php /**PATH C:\Users\Personal\Desktop\rescatando-mascotas\resources\views/cards/registro-exitoso.blade.php ENDPATH**/ ?>