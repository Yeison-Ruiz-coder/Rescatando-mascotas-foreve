<nav class="navbar navbar-expand-lg custom-navbar">
    <div class="container-fluid">
        <a class="navbar-brand" href="<?php echo e(route('inicio')); ?>">
            <img src="<?php echo e(asset('img/logo-claro.png')); ?>" alt="Rescatando Mascotas Forever Logo" class="navbar-logo">
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav mx-auto first-row-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link main-btn" href="<?php echo e(route('adopciones.index')); ?>">ADOPTA</a>
                </li>
                <li class="nav-item">
        ...
        <ul class="nav second-row-nav">
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu second-row-menu" aria-labelledby="dropdownMascotas">
                    <li><a class="dropdown-item" href="<?php echo e(route('mascotas.create')); ?>">Reportar</a></li>
                    <li><a class="dropdown-item" href="<?php echo e(route('mascotas.index')); ?>">Buscar</a></li>
...
</div><?php /**PATH C:\Users\Juanda\Desktop\Rescatando-mascotas-foreve\resources\views/includes/navbar.blade.php ENDPATH**/ ?>